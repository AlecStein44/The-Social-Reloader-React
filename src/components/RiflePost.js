...
class RiflePost extends React.Component {
    constructor(props) {
        super(props)
        this.state = {
            name: '',
    ...
    handleSubmit(e) {
        ...
        fetch(`https://the-social-reloader-server.herokuapp.com/riflepost`, {  
            method: 'POST',  
            body: formData 
        })
        .then(function (data) {  
        ...
        return(
            <section>
                <div className="Container">
                    <Header />
                    <main>
                        <h3 className="post-h3">New Rifle Post</h3>
                        <div class="post-div">
